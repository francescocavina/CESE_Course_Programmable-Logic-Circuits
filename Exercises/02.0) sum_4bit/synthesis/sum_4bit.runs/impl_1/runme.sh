...
HD_PWD='/home/francesco/Desktop/sum_4bit/synthesis/sum_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_4bit_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum_4bit_VIO.tcl -notrace
