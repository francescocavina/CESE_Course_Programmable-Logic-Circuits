...
HD_PWD='/home/francesco/Desktop/sum_4bit/synthesis/sum_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_4bit_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_4bit_VIO.tcl
