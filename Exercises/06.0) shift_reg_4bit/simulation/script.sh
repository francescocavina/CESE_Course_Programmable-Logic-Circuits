...
ghdl -a ../sources/ffd.vhd ../sources/shift_reg_4bit.vhd ../sources/shift_reg_4bit_tb.vhd
ghdl -s ../sources/ffd.vhd ../sources/shift_reg_4bit.vhd ../sources/shift_reg_4bit_tb.vhd
