...
HD_PWD='/home/francesco/Desktop/floating_point_adder/synthesis/floating_point_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_adder_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source floating_point_adder_VIO.tcl -notrace
