...
HD_PWD='/home/francesco/Desktop/floating_point_adder/synthesis/floating_point_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_adder_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_adder_VIO.tcl
